...
Second, you calculate the overlap function, which is the number of binaries located within one frequency bin. (Eq. (2.23) of [paper](https://arxiv.org/abs/2601.18378)). An example command is
```
