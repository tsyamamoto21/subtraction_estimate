...
Second, you calculate the overlap function, which is the number of binaries located within one frequency bin. (Eq. XX of [paper](https://arxiv.org/abs/2601.18378)).
```
